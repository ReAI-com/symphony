defmodule SymphonyElixir.CoreTest do
  ...
  test "current WORKFLOW.md file is valid and complete" do
    ...
    assert Map.get(hooks, "after_create") =~ "SYMPHONY_HOME"
    assert Map.get(hooks, "after_create") =~ "WAINAO_EDITOR_LOCAL_SOURCE"
    assert Map.get(hooks, "after_create") =~ "copy_wainao_local_config.sh"
    refute Map.get(hooks, "after_create") =~ "/Users/"
